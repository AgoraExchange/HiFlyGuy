...
export function setupDirector({ viewport, prepare }) {
  ...
  function ensureStage(){
    ...
    if(!stage){stage=selected==='tesla'?new TeslaStage(frame):selected==='comeback'?new ComebackStage(frame):selected==='lab'?new LabStage(frame):new DirectorStage(frame);stageKind=selected;}
    return stage;
  }
